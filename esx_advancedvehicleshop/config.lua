...
Config.Ambulance = {
	...
	Markers = {
		...
		Resell = {Type = 1, r = 255, g = 0, b = 0, x = 5.0, y = 5.0, z = 1.0} -- Medium Size Circle.
	},
	Locations = {
		Los_Santos = {
...
Config.Police = {
	...
	Markers = {
		...
		Resell = {Type = 1, r = 0, g = 0, b = 255, x = 5.0, y = 5.0, z = 1.0} -- Medium Size Circle.
	},
	Locations = {
		Los_Santos = {
...
Config.Mechanic = {
	...
	Markers = {
		...
		Resell = {Type = 1, r = 255, g = 165, b = 0, x = 5.0, y = 5.0, z = 1.0} -- Medium Size Circle.
	},
	Locations = {
		Los_Santos = {
...
Config.Aircraft = {
	...
	Markers = {
		...
		Resell = {Type = 1, r = 145, g = 0, b = 255, x = 5.0, y = 5.0, z = 1.0} -- Medium Size Circle.
	},
	Locations = {
		Los_Santos = {
...
Config.Boat = {
	...
	Markers = {
		...
		Resell = {Type = 1, r = 0, g = 17, b = 255, x = 5.0, y = 5.0, z = 1.0} -- Medium Size Circle.
	},
	Locations = {
		Los_Santos = {
			Enter = vector3(-806.5, -1350.9, 4.2),
			Inside = vector3(-816.1, -1422.0, -0.4),
			Outside = vector3(-782.0, -1421.4, -0.4),
			Resell = vector3(-769.1, -1378.0, -0.4),
			InsideH = 138.4,
			OutsideH = 141.35
		}
	}
...
Config.Car = {
	...
	Markers = {
		...
		Resell = {Type = 1, r = 0, g = 255, b = 0, x = 5.0, y = 5.0, z = 1.0} -- Medium Size Circle.
	},
	Locations = {
		Los_Santos = {
			Enter = vector3(-55.0, -1095.9, 25.4),
...
Config.Truck = {
	...
	Locations = {
		Los_Santos = {
			...
			Outside2 = vector3(-55.05, -1685.02, 28.49),
...
Config.VIPAircraft = {
	...
	Markers = {
		...
		Resell = {Type = 1, r = 255, g = 222, b = 0, x = 5.0, y = 5.0, z = 1.0} -- Medium Size Circle.
	},
	Locations = {
		Los_Santos = {
