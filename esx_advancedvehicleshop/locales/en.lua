Locales['en'] = {
  -- Shared
  ['vehicle_dealer'] = 'Vehicle Dealership',
  ...
  ['vehicle_belongs'] = 'an %s with Plate ~y~%s~s~ now belongs to ~b~YOU~s~',
  ...
  -- Taxi Shop
  ['taxi_menu'] = 'press ~INPUT_CONTEXT~ to access the ~o~Taxi Shop',
  ['taxi_dealer'] = 'dealership | Taxi',
  ...
  -- VIP Shop
  ['vipa_menu'] = 'press ~INPUT_CONTEXT~ to access the ~y~VIP Aircraft Shop',
  ['vipb_menu'] = 'press ~INPUT_CONTEXT~ to access the ~y~VIP Boat Shop',
  ['vipc_menu'] = 'press ~INPUT_CONTEXT~ to access the ~y~VIP Car Shop',
