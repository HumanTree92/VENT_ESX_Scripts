...
-- Marker = Enter Location | Spawner = Spawn Location | Spawner2 = Aircraft Spawn Location | Spawner3 = Large Spawn Location
-- Deleter = Delete Location | Deleter2 = Aircraft Delete Location | Deleter3 = Large Delete Location
-- Heading = Spawn Heading | Heading2 = Aircraft Spawn Heading | Heading3 = Large Spawn Heading
...
Config.Police = {
	...
	Garages = {
		Los_Santos = {
			...
			Spawner3 = vector3(441.78, -1015.18, 28.67),
			Deleter = vector3(462.95, -1014.56, 27.07),
			Deleter2 = vector3(449.21, -981.35, 42.69),
			Deleter3 = vector3(456.31, -1024.74, 27.45),
			Heading = 90.46,
			Heading2 = 184.53,
			Heading3 = 89.96
		}
...
Config.Taxi = {
	...
	Garages = {
		Los_Santos = {
			Marker = vector3(898.99, -168.47, 73.17),
			Spawner = vector3(902.79, -183.52, 72.91),
			Deleter = vector3(894.92, -186.39, 72.74),
			Heading = 327.45
		}
	},
	Pounds = {
		Los_Santos = {
			Marker = vector3(-194.22, -1164.39, 22.67),
			Spawner = vector3(-238.13, -1171.73, 22.04),
			Heading = 173.65
		}
	}
}
...
Config.Cars = {
	...
	Garages = {
		Los_Santos = {
			Marker = vector3(213.65, -809.02, 30.01),
			Spawner = vector3(229.70, -800.12, 29.57),
			Deleter = vector3(223.80, -760.42, 29.65),
			Heading = 157.84
		},
		Los_Santos_Airport = {
			Marker = vector3(-1016.65, -2696.04, 12.98),
			Spawner = vector3(-980.4, -2701.06, 12.86),
			Deleter = vector3(-951.55, -2705.48, 12.83),
			Heading = 56.0
		},
		Sandy_Shores = {
